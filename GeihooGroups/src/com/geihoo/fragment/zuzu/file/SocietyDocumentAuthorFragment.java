...
public class SocietyDocumentAuthorFragment extends BaseFragment {
	...
	private List<HashMap<String, Object>> getimageList(int i){
		...
		case 1:
			  ...
			  map2.put("detailinfo", "1.04KB  陈翔  2015-9-2");
			  imagelist.add(map2);
			break;
		case 2:
			  ...
			  map3.put("detailinfo", "1.04MB  汪宏达  2015-9-3");
			  imagelist.add(map3);
			break;
		case 3:
			  ...
			  map4.put("detailinfo", "5.55MB  陈子正  2015-9-4");
			  imagelist.add(map4);
			  ...
			  map6.put("detailinfo", "2.04MB  陈子正  2015-9-6");
			  imagelist.add(map6);
			break;
		case 4:
			  ...
			  map7.put("detailinfo", "1.04MB  蔡跃勇  2015-9-31");
			  imagelist.add(map7);
			break;
		default:
			break;
