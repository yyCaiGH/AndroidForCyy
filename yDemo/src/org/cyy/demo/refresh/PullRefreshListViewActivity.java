...
public class PullRefreshListViewActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //这两种方法只能选其一
//        mPullListView.setPullLoadEnabled(false);//框架已实现,不能设置这个方法为false来启动自己加载，因为还要设置界面等问题
        mPullListView.setScrollLoadEnabled(true);//自己实现，自己设置界面，如果是listview，可以直接mListView.addFooterView（）来添加界面，并通过onScrollListener来实现自动加载
...
//        mPullListView.doPullRefreshing(true, 500);
    ...
    private class GetDataTask extends AsyncTask<Void, Void, String[]> {
    	...
    	boolean isDown ;
    	public GetDataTask(boolean isDown){
    		this.isDown = isDown;
    	}
        @Override
        ...
        protected void onPostExecute(String[] result) {
            ...
            if (isDown) {
                mListItems.addFirst("下拉刷新..."+pullDown++);
                mListItems.addFirst("下拉刷新..."+pullDown++);
                mListItems.addFirst("下拉刷新..."+pullDown++);
                mListItems.addFirst("下拉刷新..."+pullDown++);
            } else {
               /* int start = mCurIndex;
                ...
                mCurIndex = end;*/
            	mListItems.addLast("上拉加载..."+pullUp++);
            	mListItems.addLast("上拉加载..."+pullUp++);
            	mListItems.addLast("上拉加载..."+pullUp++);
            	mListItems.addLast("上拉加载..."+pullUp++);
            }
