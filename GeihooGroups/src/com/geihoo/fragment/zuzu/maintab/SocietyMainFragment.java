	...
	private void initPostListView(View view) {
		...
		if (mZuzu != null) {
			if (mZuzu.getBgIcon() == null) {
				zuzubg.setImageBitmap(ImageUtil.readBitMap(activity,
		...
		if (mZuzu != null) {
			if (mZuzu.getHeadIcon() == null) {
				zuzuHeadImg.setPic(ImageUtil.readBitMap(activity,
