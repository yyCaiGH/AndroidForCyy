 ...
 * @author Zaric
 */
public class DynamicListView extends DynamicBaseListView {
    ...
    private void measureScrapChild(View child, int position, int widthMeasureSpec) {
        ...
        if (p == null) {
            p = (DynamicBaseListView.LayoutParams) generateDefaultLayoutParams();
    ...
    final int measureHeightOfChildren(int widthMeasureSpec, int startPosition, int endPosition,
        ...
        final DynamicBaseListView.RecycleBin recycleBin = mRecycler;
    ...
    private void setupChild(View child, int position, int y, boolean flowDown, int childrenLeft,
        ...
        DynamicBaseListView.LayoutParams p = (DynamicBaseListView.LayoutParams) child.getLayoutParams();
        if (p == null) {
            p = (DynamicBaseListView.LayoutParams) generateDefaultLayoutParams();
        }
        p.viewType = mAdapter.getItemViewType(position);
        ...
        if ((recycled && !p.forceAdd)
                ...
                p.viewType == DynamicAdapterView.ITEM_VIEW_TYPE_HEADER_OR_FOOTER)) {
            attachViewToParent(child, flowDown ? -1 : 0, p);
        } else {
            p.forceAdd = false;
            if (p.viewType == DynamicAdapterView.ITEM_VIEW_TYPE_HEADER_OR_FOOTER) {
        ...
        if (recycled &&
                (((DynamicBaseListView.LayoutParams) child.getLayoutParams()).scrappedFromPosition) !=
                        position) {
            if (AppUtil.isSupport(11)) {
    ...
    private void scrollListItemsBy(int amount) {
        ...
        if (amount < 0) {
            ...
            while (first.getBottom() < listTop) {
                DynamicBaseListView.LayoutParams layoutParams = (LayoutParams) first.getLayoutParams();
            ...
            while (last.getTop() > listBottom) {
                DynamicBaseListView.LayoutParams layoutParams = (LayoutParams) last.getLayoutParams();
                if (recycleBin.shouldRecycleViewType(layoutParams.viewType)) {
    ...
    public static interface OnScrollListener {
        ...
        public void onScrollStateChanged(DynamicBaseListView view, int scrollState);

        public void onScroll(DynamicBaseListView view, int firstVisibleItem, int visibleItemCount,
                int totalItemCount);
    }

    public interface OnItemClickListener {
        void onItemClick(DynamicListView parent, View view, int position, long id);
    }

    public interface OnItemLongClickListener {
        boolean onItemLongClick(DynamicListView parent, View view, int position, long id);
    }
